...
public class VerticalCurveSlicer extends Slicer {
    ...
    public VerticalCurveSlicer(int i, int i2, int i3, int i4) {
        super(i, i2, i3, i4);
    ...
    public void createPath(float f) {
        ...
        float f2 = (-f) / 2.0f;
        float f3 = f / 2.0f;
        this.path.arcTo(new RectF(((float) this.increment) + f2, 0.0f, ((float) this.increment) + f3, (float) this.screenHeight), 270.0f, 180.0f);
        this.path.lineTo(0.0f, (float) this.screenHeight);
        this.path.moveTo(0.0f, 0.0f);
        this.path.arcTo(new RectF(f2, 0.0f, f3, (float) this.screenHeight), 270.0f, 180.0f);
